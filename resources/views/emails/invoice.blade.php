    			...
    			<div class="panel-body">
    				<div class="table-responsive">
    					<table class="line-item-tbl" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    						<thead>
                                <tr>
        							<td style="width: 30%; font-size:12px;"><strong>Item</strong></td>
        							<td style="width: 30%;font-size:12px;"><strong>Category</strong></td>
        							...
        							<td style="width: 20%;font-size:12px;"><strong>Totals</strong></td>
                                </tr>
    						</thead>
    						<tbody>
    						@foreach ($maildata as $line) 
    							<tr class="line-item">
    								<td style="width: 30%;font-size:12px;">{{$line->product_name}}</td>
    								<td style="width: 30%;font-size:12px;">{{$line->product_category}}</td>
    								...
    								<td style="width: 20%;font-size:12px;">$ {{$line->price}}</td>
    							</tr>
